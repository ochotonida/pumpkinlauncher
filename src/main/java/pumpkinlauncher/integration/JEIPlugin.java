...
public class JEIPlugin implements IModPlugin {
    ...
    private void addContainerRecipes(IModRegistry registry) {
        ...
        registry.addRecipes(Arrays.asList(
                new ItemStackRecipeWrapper(output0, pumpkin, gunpowder, gunpowder, gunpowder),
                ...
                new ItemStackRecipeWrapper(output3, pumpkin, new ItemStack(Items.SLIME_BALL, 1, OreDictionary.WILDCARD_VALUE)),
